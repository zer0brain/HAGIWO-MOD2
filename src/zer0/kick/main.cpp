...
zer0 Kick Drum v1.0
Sine-based kick drum with 6 parameters and dual edit modes.
Button switches between pitch/clip/decay and f0/f1/curve.

-- Pin assignment --
POT1   A0   Pitch | Start frequency
POT2   A1   Soft-clip rate | End frequency
POT3   A2   Amp envelope | Pitch envelope
IN1    GPIO7  Trigger (clock in)
IN2    GPIO0  Accent (volume reduction when HIGH)
CV     A2     Shared with POT3
OUT    GPIO1  Audio PWM output
BUTTON GPIO6  Mode change
LED    GPIO5  Status
EEPROM Used for parameter storage
